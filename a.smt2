...
(assert-soft (not G1 ) :weight 3 :id pos)
(assert-soft G1 :weight 2 :id eff)
(assert-soft (not G2 ) :id sat_tasks)
(assert-soft (not G2 ) :weight 10 :id pos)
(assert-soft G2 :weight 1 :id eff)
(assert-soft (not G4 ) :id sat_tasks)
(assert-soft (not G4 ) :weight 4 :id pos)
(assert-soft G4 :weight 2 :id eff)
(minimize pos)
(minimize eff)
