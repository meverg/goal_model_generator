 ...
 * in case of errors.
 */
msat_objective msat_make_minimize(msat_env e, msat_term term, msat_term lower,
                                  msat_term upper);
 ...
 * in case of errors.
 */
msat_objective msat_make_maximize(msat_env e, msat_term term, msat_term lower,
                                  msat_term upper);
...
/**
 * \brief Push a mssat_objective on the objective stack
 * \param e The Environment in which the objective is pushed
 * \param o The msat_objective to push
 */
void msat_assert_objective(msat_env e, msat_objective o);
