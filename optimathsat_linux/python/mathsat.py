...
_mathsat.MSAT_OPTIMUM_swigconstant(_mathsat)
MSAT_OPTIMUM = _mathsat.MSAT_OPTIMUM

_mathsat.MSAT_INITIAL_LOWER_swigconstant(_mathsat)
MSAT_INITIAL_LOWER = _mathsat.MSAT_INITIAL_LOWER

_mathsat.MSAT_INITIAL_UPPER_swigconstant(_mathsat)
MSAT_INITIAL_UPPER = _mathsat.MSAT_INITIAL_UPPER

_mathsat.MSAT_FINAL_LOWER_swigconstant(_mathsat)
MSAT_FINAL_LOWER = _mathsat.MSAT_FINAL_LOWER

_mathsat.MSAT_FINAL_UPPER_swigconstant(_mathsat)
MSAT_FINAL_UPPER = _mathsat.MSAT_FINAL_UPPER

_mathsat.MSAT_FINAL_ERROR_swigconstant(_mathsat)
MSAT_FINAL_ERROR = _mathsat.MSAT_FINAL_ERROR

_mathsat.MSAT_FINAL_TOLERANCE_swigconstant(_mathsat)
MSAT_FINAL_TOLERANCE = _mathsat.MSAT_FINAL_TOLERANCE

_mathsat.MSAT_OBJECTIVE_MINIMIZE_swigconstant(_mathsat)
MSAT_OBJECTIVE_MINIMIZE = _mathsat.MSAT_OBJECTIVE_MINIMIZE

_mathsat.MSAT_OBJECTIVE_MAXIMIZE_swigconstant(_mathsat)
MSAT_OBJECTIVE_MAXIMIZE = _mathsat.MSAT_OBJECTIVE_MAXIMIZE

_mathsat.MSAT_OPT_UNKNOWN_swigconstant(_mathsat)
MSAT_OPT_UNKNOWN = _mathsat.MSAT_OPT_UNKNOWN

_mathsat.MSAT_OPT_UNSAT_swigconstant(_mathsat)
MSAT_OPT_UNSAT = _mathsat.MSAT_OPT_UNSAT

_mathsat.MSAT_OPT_SAT_PARTIAL_swigconstant(_mathsat)
MSAT_OPT_SAT_PARTIAL = _mathsat.MSAT_OPT_SAT_PARTIAL

_mathsat.MSAT_OPT_SAT_APPROX_swigconstant(_mathsat)
MSAT_OPT_SAT_APPROX = _mathsat.MSAT_OPT_SAT_APPROX

_mathsat.MSAT_OPT_SAT_OPTIMAL_swigconstant(_mathsat)
...
def msat_set_external_maxsat_engine(env, engine):
    return _mathsat.msat_set_external_maxsat_engine(env, engine)
msat_set_external_maxsat_engine = _mathsat.msat_set_external_maxsat_engine

def msat_push_minimize(e, term, lower, upper, bvsigned=False):
    return _mathsat.msat_push_minimize(e, term, lower, upper, bvsigned)
msat_push_minimize = _mathsat.msat_push_minimize

def msat_push_maximize(e, term, lower, upper, bvsigned=False):
    return _mathsat.msat_push_maximize(e, term, lower, upper, bvsigned)
msat_push_maximize = _mathsat.msat_push_maximize

def msat_push_minmax(e, len, terms, lower, upper, bvsigned=False):
    return _mathsat.msat_push_minmax(e, len, terms, lower, upper, bvsigned)
msat_push_minmax = _mathsat.msat_push_minmax

def msat_push_maxmin(e, len, terms, lower, upper, bvsigned=False):
    return _mathsat.msat_push_maxmin(e, len, terms, lower, upper, bvsigned)
msat_push_maxmin = _mathsat.msat_push_maxmin

def msat_assert_soft_formula(e, term, weight, id):
    return _mathsat.msat_assert_soft_formula(e, term, weight, id)
msat_assert_soft_formula = _mathsat.msat_assert_soft_formula

def msat_set_pareto_model_callback(env, func, user_data):
    return _mathsat.msat_set_pareto_model_callback(env, func, user_data)
msat_set_pareto_model_callback = _mathsat.msat_set_pareto_model_callback

def msat_create_objective_iterator(e):
    return _mathsat.msat_create_objective_iterator(e)
msat_create_objective_iterator = _mathsat.msat_create_objective_iterator

def msat_objective_iterator_has_next(i):
    return _mathsat.msat_objective_iterator_has_next(i)
msat_objective_iterator_has_next = _mathsat.msat_objective_iterator_has_next

def msat_objective_iterator_next(i, o):
    return _mathsat.msat_objective_iterator_next(i, o)
msat_objective_iterator_next = _mathsat.msat_objective_iterator_next

def msat_destroy_objective_iterator(i):
    return _mathsat.msat_destroy_objective_iterator(i)
msat_destroy_objective_iterator = _mathsat.msat_destroy_objective_iterator

def msat_objective_result(e, o):
    return _mathsat.msat_objective_result(e, o)
msat_objective_result = _mathsat.msat_objective_result

def msat_objective_get_term(e, o):
    return _mathsat.msat_objective_get_term(e, o)
msat_objective_get_term = _mathsat.msat_objective_get_term

def msat_objective_get_type(e, o):
    return _mathsat.msat_objective_get_type(e, o)
msat_objective_get_type = _mathsat.msat_objective_get_type

def msat_set_model(e, o):
    return _mathsat.msat_set_model(e, o)
msat_set_model = _mathsat.msat_set_model

def msat_objective_get_search_stats(e, o):
    return _mathsat.msat_objective_get_search_stats(e, o)
msat_objective_get_search_stats = _mathsat.msat_objective_get_search_stats

def msat_objective_value_is_unbounded(e, o, i):
    return _mathsat.msat_objective_value_is_unbounded(e, o, i)
msat_objective_value_is_unbounded = _mathsat.msat_objective_value_is_unbounded

def msat_objective_value_is_plus_inf(e, o, i):
    return _mathsat.msat_objective_value_is_plus_inf(e, o, i)
msat_objective_value_is_plus_inf = _mathsat.msat_objective_value_is_plus_inf

def msat_objective_value_is_minus_inf(e, o, i):
    return _mathsat.msat_objective_value_is_minus_inf(e, o, i)
msat_objective_value_is_minus_inf = _mathsat.msat_objective_value_is_minus_inf

def msat_objective_value_is_strict(e, o, i, d):
    return _mathsat.msat_objective_value_is_strict(e, o, i, d)
msat_objective_value_is_strict = _mathsat.msat_objective_value_is_strict

def msat_objective_value_term(e, o, i, fin=False, eps=False):
    return _mathsat.msat_objective_value_term(e, o, i, fin, eps)
msat_objective_value_term = _mathsat.msat_objective_value_term

def msat_objective_value_repr(e, o, i):
    return _mathsat.msat_objective_value_repr(e, o, i)
msat_objective_value_repr = _mathsat.msat_objective_value_repr

def msat_objective_get_model(e, o):
    return _mathsat.msat_objective_get_model(e, o)
